#if !defined(AFX_CDispatchInbox_H__73A206AD_CAAF_4CDC_9796_E1302F97ACD9__INCLUDED_)
#define AFX_CDispatchInbox_H__73A206AD_CAAF_4CDC_9796_E1302F97ACD9__INCLUDED_
...
class CDispatchInbox : public CDialogBase
{
public:
	//变换语言和单位
	...
	// Construction
public:
	CDispatchInbox(CWnd* pParent = NULL);   // standard constructor
