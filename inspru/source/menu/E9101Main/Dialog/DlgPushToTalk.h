#if !defined(AFX_CDlgPushToTalk__9DDECABA_28AE_40E9_82E3_9F05A2043CEB__INCLUDED_)
#define AFX_CDlgPushToTalk__9DDECABA_28AE_40E9_82E3_9F05A2043CEB__INCLUDED_
...
class CDlgPushToTalk : public CDialogBase
{
	enum{ enCtrCount = 6 };
public:
	//变换语言和单位
	...
	// Construction
public:
	CDlgPushToTalk(CWnd* pParent = NULL);   // standard constructor
	// Dialog Data
	//{{AFX_DATA(CMediaMain)
	enum { IDD = IDD_DLG_PUSH_TO_TALK };;
