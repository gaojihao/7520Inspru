#if !defined(AFX_SMSCENTERLIST_H__CFBFFWE2342342CB3789__INCLUDED_)
#define AFX_SMSCENTERLIST_H__CFBFFWE2342342CB3789__INCLUDED_
...
class CDlgTextInfoList : public CDialogBase
{
	enum { BTN_COUNT = 4 };
public:
	//变换语言和单位
	...
	static int  m_iInfoType;
	
public:
	CDlgTextInfoList(BOOL bIsModelDlg = TRUE, CWnd* pParent = NULL);
