...
#if !defined(AFX_CDlgRFID_H__CVGHUYTRESXCVBNJKIUYTRESDFKUYTRESASDFBNMJUYTEDFKO7YI6TQAWI68T__INCLUDED_)
#define AFX_CDlgRFID_H__CVGHUYTRESXCVBNJKIUYTRESDFKUYTRESASDFBNMJUYTEDFKO7YI6TQAWI68T__INCLUDED_
...
class CDlgRFID : public CDialogBase
{
public:
	CDlgRFID(CWnd* pParent = NULL);	// standard constructor
...
// Dialog Data
	...
	int  CheckSum(unsigned char * uBuff,int uBuffLen);
...
#endif // !defined(AFX_CDlgRFID_H__CVGHUYTRESXCVBNJKIUYTRESDFKUYTRESASDFBNMJUYTEDFKO7YI6TQAWI68T__INCLUDED_)
