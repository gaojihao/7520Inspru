#if !defined(AFX_CDlgVideo__9DDECABA_28AE_40E9_82E3_9F05A2043CEB__INCLUDED_)
#define AFX_CDlgVideo__9DDECABA_28AE_40E9_82E3_9F05A2043CEB__INCLUDED_
...
class CDlgVideo : public CDialogBase
{
	enum{ enCtrCount = 5 };
public:
	//变换语言和单位
