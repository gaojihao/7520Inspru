#if !defined(AFX_INFOMENU_H__CFOIUYTREWJNHBGFCDXS9__INCLUDED_)
#define AFX_INFOMENU_H__CFOIUYTREWJNHBGFCDXS9__INCLUDED_
...
class CDlgInfoMenu : public CDialogBase
{
	enum { BTN_COUNT = 4 };
public:
	//变换语言和单位
	...
	static UINT	WM_DlgInfoMenu_Refresh;
	
public:
	CDlgInfoMenu(BOOL bIsModelDlg = TRUE, CWnd* pParent = NULL);
