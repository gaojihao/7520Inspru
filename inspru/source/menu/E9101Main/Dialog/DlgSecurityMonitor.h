#if !defined(AFX_CDlgSecurityMonitor__9DDECABA_28AE_40E9_82E3_9F05A2043CEB__INCLUDED_)
#define AFX_CDlgSecurityMonitor__9DDECABA_28AE_40E9_82E3_9F05A2043CEB__INCLUDED_
...
class CDlgSecurityMonitor : public CDialogBase
{
	enum{ enCtrCount = 5 };
public:
	//变换语言和单位
	...
	// Construction
public:
	CDlgSecurityMonitor(CWnd* pParent = NULL);   // standard constructor
	// Dialog Data
	//{{AFX_DATA(CMediaMain)
	enum { IDD = IDD_DLG_SECURITY_MONITOR };;
