#if !defined(AFX_CDlgDriveEconomySetting__9DDECABA_28AE_40E9_82E3_9F05A2043CEB__INCLUDED_)
#define AFX_CDlgDriveEconomySetting__9DDECABA_28AE_40E9_82E3_9F05A2043CEB__INCLUDED_
...
class CDlgDriveEconomySetting : public CDialogBase
{
	enum{ enCtrCount = 4 };
public:
	//变换语言和单位
	...
	// Construction
public:
	CDlgDriveEconomySetting(CWnd* pParent = NULL);   // standard constructor
	// Dialog Data
	//{{AFX_DATA(CMediaMain)
