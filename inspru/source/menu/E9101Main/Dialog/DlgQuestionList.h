#if !defined(AFX_QUESTION_H__CFHFAFWERGHWERWFVAERWFGe9__INCLUDED_)
#define AFX_QUESTION_H__CFHFAFWERGHWERWFVAERWFGe9__INCLUDED_
...
class CDlgQuestionList : public CDialogBase
{
	enum { BTN_COUNT = 4 };
public:
	//变换语言和单位
...
public:
	CDlgQuestionList(BOOL bIsModelDlg = TRUE, CWnd* pParent = NULL);
