#if !defined(AFX_CDlgDriveEconomy__9DDECABA_28AE_40E9_82E3_9F05A2043CEB__INCLUDED_)
#define AFX_CDlgDriveEconomy__9DDECABA_28AE_40E9_82E3_9F05A2043CEB__INCLUDED_
...
class CDlgDriveEconomy : public CDialogBase
{
	enum{ enCtrCount = 4 };
public:
	//变换语言和单位
	...
	// Construction
public:
	CDlgDriveEconomy(CWnd* pParent = NULL);   // standard constructor
	// Dialog Data
	//{{AFX_DATA(CMediaMain)
	enum { IDD = IDD_DLG_DRIVE_ECONOMY };;
