================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : WirelessManager Project Overview
===============================================================================

The application wizard has created this WirelessManager application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your WirelessManager application.

WirelessManager.vcproj
...
WirelessManager.h
    ...
    project specific headers and declares the CWirelessManagerApp application class.

WirelessManager.cpp
    This is the main application source file that contains the application
    class CWirelessManagerApp.
...
WirelessManagerDlg.h, WirelessManagerDlg.cpp - the dialog
    These files contain your CWirelessManagerDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named WirelessManager.pch and a precompiled types file named StdAfx.obj.
