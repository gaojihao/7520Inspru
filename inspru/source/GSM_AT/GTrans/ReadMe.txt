================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : GTrans Project Overview
===============================================================================

The application wizard has created this GTrans application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your GTrans application.
...
GTrans.h
    ...
    project specific headers and declares the CGTransApp application class.
...
GTransDlg.h, GTransDlg.cpp - the dialog
    These files contain your CGTransDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named GTrans.pch and a precompiled types file named StdAfx.obj.
