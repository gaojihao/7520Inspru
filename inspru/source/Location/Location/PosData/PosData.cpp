...
BOOL CPosData::SetDataMode(enPOS_DATA_MODE data_mode)
{
	...
	unsigned char unublox_cfg[ ]=
	{
		0xB5,0x62,0x06,0x24,0x24,0x00,0xFF,0xFF,0x04,0x03,0x00,0x00,0x00,0x00,0x10,
		0x27,0x00,0x00,0x05,0x00,0xFA,0x00,0xFA,0x00,0x64,0x00,0x2C,0x01,0x64,0x00,
		0x00,0x00,0x10,0x27,0xF4,0x01,0x00,0x00,0x00,0x00,0x00,0x00,0xA4,0xB6
	};
	m_pPosCom->SendData((PBYTE)unublox_cfg, sizeof(unublox_cfg));
	return TRUE;
}
